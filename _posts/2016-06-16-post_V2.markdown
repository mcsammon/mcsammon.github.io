...
<p> A good place to get started is the definition of Granger Causality: We say that $$x$$ fails to Granger-Cause $$y$$ if including $$x$$ in our model does not make our forecasts of $$y$$ more accurate. More formally, $$x$$ fails to Granger-Cause $$y$$ if for all $$s>0$$ </p>
\begin{equation}
