...
Despite the issues raised above, I think the contribution is still strong.  If nothing else, it provides a possible explanation for momentum crashes: high shorting costs prevent the market from keeping prices in line with fundamentals.
