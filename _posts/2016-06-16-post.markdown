...
\begin{equation} \text{[c]} c^{-\frac{1}{\gamma}}=\lambda \end{equation}
\begin{equation} \text{[k']} \beta v'(k') = \lambda \end{equation}
\begin{equation} \text{[Envelope]} v'(k)= \lambda \end{equation}
