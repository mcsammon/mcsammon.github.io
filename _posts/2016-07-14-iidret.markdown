...
Check <a href="http://marcosammon.com/spy-vol/"> here </a> to see realized volatility for the past 30 days (this will be fully populated by the end of August, 2016).  Future posts will test the effect of time varying volatility on well-known finance models, and if normalizing by realized volatility can preserve the major results.
